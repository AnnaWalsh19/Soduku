...
'''def ViewGrid(grid):
    ...
    htmlstr+="</table>"
    display(HTML(htmlstr))''' # This can only be used on a web browser 
...
mygrid = ConvertToList("003020600900305001001806400008102900700000008006708200002609500800203009005010300")
print("mygrid: ", mygrid)

mysolved = SolveSudoku(mygrid, 0)
print('solved sudoku is: ', mysolved)

mystring = ConvertToString(mysolved)
print('Final answer as a string is: ', mystring)
